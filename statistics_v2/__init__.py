...
def main(name:str):
    ...
    statistics_v2_list= list()

    # Extract recommendations roster for a given stock
    querystring_list= qs.statistics_v2_query_string(auto_complete_list)
    url = "https://apidojo-yahoo-finance-v1.p.rapidapi.com/stock/v2/get-statistics"
    
    for querystring in querystring_list:
        statistics_v2_dict= miner(url, querystring)
        statistics_v2_list.append(statistics_v2_dict)
    
    # Moving out the file to blob and datalake
    fm.statistics_v2_mover_out(statistics_v2_list)
